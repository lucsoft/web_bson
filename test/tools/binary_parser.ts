...
function BinaryParser(bigEndian: any, allowExceptions: any) {
...
BinaryParser.warn = function warn(msg: string) {
...
BinaryParser.toSmall = function (data: any) {
  return this.decodeInt(data, 8, true);
};
BinaryParser.fromSmall = function (data: any) {
  return this.encodeInt(data, 8, true);
};
BinaryParser.toByte = function (data: any) {
  return this.decodeInt(data, 8, false);
};
BinaryParser.fromByte = function (data: any) {
  return this.encodeInt(data, 8, false);
};
BinaryParser.toShort = function (data: any) {
  return this.decodeInt(data, 16, true);
};
BinaryParser.fromShort = function (data: any) {
  return this.encodeInt(data, 16, true);
};
BinaryParser.toWord = function (data: any) {
  return this.decodeInt(data, 16, false);
};
BinaryParser.fromWord = function (data: any) {
  return this.encodeInt(data, 16, false);
};
BinaryParser.toInt = function (data: any) {
  return this.decodeInt(data, 32, true);
};
BinaryParser.fromInt = function (data: any) {
  return this.encodeInt(data, 32, true);
};
BinaryParser.toLong = function (data: any) {
  return this.decodeInt(data, 64, true);
};
BinaryParser.fromLong = function (data: any) {
  return this.encodeInt(data, 64, true);
};
BinaryParser.toDWord = function (data: any) {
  return this.decodeInt(data, 32, false);
};
BinaryParser.fromDWord = function (data: any) {
  return this.encodeInt(data, 32, false);
};
BinaryParser.toQWord = function (data: any) {
  return this.decodeInt(data, 64, true);
};
BinaryParser.fromQWord = function (data: any) {
  return this.encodeInt(data, 64, true);
};
BinaryParser.toFloat = function (data: any) {
  return this.decodeFloat(data, 23, 8);
};
BinaryParser.fromFloat = function (data: any) {
  return this.encodeFloat(data, 23, 8);
};
BinaryParser.toDouble = function (data: any) {
  return this.decodeFloat(data, 52, 11);
};
BinaryParser.fromDouble = function (data: any) {
...
BinaryParser.ilprint = function hprint(s: any) {
  var number;
