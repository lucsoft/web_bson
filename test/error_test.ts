...
Deno.test("BSONTypeError", async ({ step }) => {
  await step(
    "should evaluate true on instanceof BSONTypeError and TypeError",
    () => {
  ...
  await step(
    "should correctly set BSONTypeError name and message properties",
    () => {
...
Deno.test("BSONError", async ({ step }) => {
  await step("should evaluate true on instanceof BSONError and Error", () => {
  ...
  await step(
    "should correctly set BSONError name and message properties",
    () => {
